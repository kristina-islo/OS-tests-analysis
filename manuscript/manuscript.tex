...
In this paper, we introduce an improved method for computing the optimal statistic, 
a frequentist estimator for the strength of an isotropic stochastic GWB in PTA data 
that searches for a common signal with a particular spatial correlation relation 
using a matched filter approach. 
Our method uses the output from a Bayesian analyses 
