...
including one where the residuals contain evidence of an isotropic GW stochastic background \sv{add citation}. 
...
optimal statistic, a frequentist estimator for the GWB amplitude \sv{add citation}. 
...
similar to the properties of the EPTA (see Table~\ref{tab:sim})  \sv{add citation}. 
