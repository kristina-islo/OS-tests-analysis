...
\sv{something...} predict that the incoherent superposition of inspiraling SMBHBs form the dominant signal in this low-frequency regime.
...
Figure~\ref{fig:os_ORF} shows the mean value of $\hat{A}^2$ and the mean SNR 
computed assuming monopole, dipole, and Hellings-Downs spatial correlations 
for 425 simulated data sets.
