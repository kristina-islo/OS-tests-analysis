...
\begin{figure}[t]
	...
	\caption{Noise-marginalized mean optimal statistic and mean SNR for 200 simulated data sets 
			...
			using monopole (blue), dipole (orange), and quadrupole (green) spatial correlations. 
			The dashed vertical line indicates the injected value, $\hat{A}^2 = 2.5 \times 10^{-29}$.}
	\label{fig:os_ORF}
\end{figure}

This overlap between the monopole, dipole, and quadrupole ORFs also means that 
a common red process that does not have Hellings-Downs correlations  
...
the Hellings-Downs ORF gives a mean SNR greater than 5 in 84\% of the simulations. 
However, both the monopole and Hellings-Downs ORFs give smaller values of 
